...
if __name__ == "__main__":
    ...
    parser.add_argument('-R', '--R0', dest='R0', type=float,
                        help='Base R0 to which the contribution will be scaled',default=1.2)
...
def make_analysis(dirs,Ru, Rv, save_figures = False, R0=1.2, verbose=True):
    ...
    for data_dir in dirs:
        ...
        if verbose:
            print("======",data_dir,"======")
            print("Reff =",R)
            print("2x2 absolute contribution matrix =\n",C)
...
if __name__=="__main__":
    make_analysis(args.directories, args.Ru, args.Rv,args.save_figures, args.R0)
