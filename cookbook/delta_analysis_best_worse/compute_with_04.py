...
for data_dir in [ '03_realistic', '04_realistic_15_perc_reduction']:
    ...
    C_full = get_contribution_matrix_covid(R0,'delta',data_dir)

    print(to_ltx(convert_4d_matrix_to_2d_block(C_full/C_full.sum()),
                 fmt='{:4.2f}',
                 separate_columns = range(5,26,5),
                 separate_rows = range(5,26,5),
                 )
          )
